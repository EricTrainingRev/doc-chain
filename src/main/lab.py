"""
    In this lab you will be using LCEL to load documents from a vectorstore to augument queries to
    an llm (essentially creating mini Retrieval Augemented Generation apps). To complete this lab you
    ...
    If you need further assistance LangChain has an example of how load documents from a vectorstore
    to augument queries to an llm here: https://python.langchain.com/docs/expression_language/get_started#rag-search-example
...
def setup_csv_retriever():
    """
        ...
        You will need to code the following:
            - An embedding function for the Chroma client compatable with LangChain's HuggingFaceInferenceAPIEmbeddings
    ...
    """
    # TODO: load "lab_csv.csv" into a Chroma vectorstore and return a Vectorstore retriever with the document
    pass
